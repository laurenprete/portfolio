...
const projects = [
  ...
  {
    image: '/assets/images/NAILanding.png',
    title: 'NAI SEO Landing Pages',
    description: 'I designed and develop dedicated landing pages for product lines with identified growth opportunities based on keyword research. \
